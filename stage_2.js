...
function hutuu(){
	if(gomi_name =="img/CDDVD.png" || gomi_name =="img/jyougi.png"){
		correct();
	}else{
		matigai=matigai-1;
...
function sigen(){
	if(gomi_name =="img/yakann.png" || gomi_name =="img/pet_hontai.png"){
		correct();
	}else{
		matigai=matigai-1;
		document.getElementById("moji2").textContent=matigai;
...
function pura(){ 
	if(gomi_name =="img/pet_ravel.png" || gomi_name =="img/pet_kyappu.png"){
		correct();
	}else{
		matigai=matigai-1;
		document.getElementById("moji2").textContent=matigai;
...
function kosiirui(){
	if(gomi_name=="img/sinnbunnsi.png"){
		correct();
	}else{
		matigai=matigai-1;
		document.getElementById("moji2").textContent=matigai;
